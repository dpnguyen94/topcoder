...
vector <int> BatchSystem::schedule(vector <int> a, vector <string> b) {
	x.clear();
...
int main() {
	...
	{
	// ----- test 2 -----
	int t0[] = {1000000000, 1000000000, 1000000000, 1000000000, 1, 2, 3};
			p0.assign(t0, t0 + sizeof(t0) / sizeof(t0[0]));
	string t1[] = {"X", "X", "X", "X", "Y", "Y", "Y"};
			p1.assign(t1, t1 + sizeof(t1) / sizeof(t1[0]));
	int t2[] = {2,0,1};
			p2.assign(t2, t2 + sizeof(t2) / sizeof(t2[0]));
