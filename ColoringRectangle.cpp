...
void solve(int w, int h, vi a, vi b) {	
	double width = (double)w;
	int color = 0, i = 0, k = 0, cnt = 0;
	while (width > 0.0) {
		if (color == 0) {
			if (i == sz(a)) {
				cnt = INT_MAX;
...
int ColoringRectangle::chooseDisks(int w, int h, vector <int> a, vector <int> b) {
